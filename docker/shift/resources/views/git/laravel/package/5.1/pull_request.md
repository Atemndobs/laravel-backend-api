This pull request includes the changes for upgrading your Laravel Package to Laravel 5.1. Feel free to commit any additional changes to the `{{branch}}` branch.
